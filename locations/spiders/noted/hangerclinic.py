...
class HangerclinicSpider(scrapy.Spider):
    ...
    def format_hours(self, datestring):
        ...
        day_dict = {'Mon':'Mo', 'Tue':'Tu', 'Wed':'We', 'Thu':'Th', 'Fri':'Fr', 'Sat':'Sa', 'Sun':'Su', 'Monday':'Mo', 'Tuesday':'Tu', 'Wednesday':'We', 'Thursday':'Th', 'Thurs':'Th', 'Thur':'Th', 'Friday':'Fr', 'Saturday':'Sa', 'Sunday':'Su', '24 hours/7 days a week':'24/7', 'Please contact store for hours':'N/A', 'Open only on':'', 'Only':'', "A.M.":"", "P.M.":""}
    ...
    def parse_store(self,response):
        ...
        city, statezip = store_info.xpath("//span[@id='locCityState']/text()").extract()[0].replace(' ', '').replace('\n', '').replace('\r', '').split(',')
