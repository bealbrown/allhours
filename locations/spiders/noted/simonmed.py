...
class SimonMedSpider(scrapy.Spider):
    ...
    start_urls = (
        'https://www.simonmed.com/locations/getLocations',
    )
    ...
    def parse(self, response):
        ...
        for store in data:
            ...
            for day_hour in store['Days']:
                opening_hours.append(day_hour['Day'][:2]+" "+self.parse_times(day_hour['Open']) + "-" + self.parse_times(day_hour['Close']))
    ...
    def start_requests(self):
        ...
        form_data = { 'location': '85251', 'miles': '1000000', 'location_lat': '33.4986286', 'location_lng': '-111.9224398'}
