...
class OreillyAuto(scrapy.Spider):
    ...
    start_urls = (
        'https://www.oreillyauto.com/locations',
    )
    ...
    def parse_hours(self, hours):
        ...
        for day_hour in zip(*[iter(hours)]*3):
            short_day, from_hr, to_hr = day_hour[0].title()[:2], day_hour[1], day_hour[2]
    ...
    def parse_stores(self, response):
        ...
        hours = response.xpath(
            '//tr[@class="c-location-hours-details-row js-day-of-week-row highlight-text"]//text()').extract()
